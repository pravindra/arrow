...
#ifndef GANDIVA_DECIMAL_VALUE_H
#define GANDIVA_DECIMAL_VALUE_H
...
class DecimalValue {
 public:
  ...
  explicit DecimalValue(const T& s) : value_(s) {}
  ...
  static inline DecimalValue FromDouble(int32_t precision, int32_t scale, double d,
                                        bool round, bool* overflow);

  /// Assigns *result as a decimal.
  static inline DecimalValue FromInt(int32_t precision, int32_t scale, int64_t d,
                                     bool* overflow);
  ...
  /// decimal_col.
  bool operator==(const DecimalValue& other) const { return value_ == other.value_; }
  bool operator!=(const DecimalValue& other) const { return value_ != other.value_; }
  bool operator<=(const DecimalValue& other) const { return value_ <= other.value_; }
  bool operator<(const DecimalValue& other) const { return value_ < other.value_; }
  bool operator>=(const DecimalValue& other) const { return value_ >= other.value_; }
  ...
  DecimalValue operator-() const { return DecimalValue(-value_); }

  bool is_negative() const { return value_ < 0; }

  /// Compares this and other. Returns 0 if equal, < 0 if this < other and > 0 if
  /// this > other.
  inline int32_t Compare(const DecimalValue& other) const;
  ...
  inline DecimalValue ScaleTo(int32_t src_scale, int32_t dst_scale, int32_t dst_precision,
                              bool* overflow) const;
  ...
  inline DecimalValue<RESULT_T> Add(int32_t this_scale, const DecimalValue& other,
                                    int32_t other_scale, int32_t result_precision,
                                    int32_t result_scale, bool round,
                                    bool* overflow) const;

  template <typename RESULT_T>
  inline DecimalValue<RESULT_T> Subtract(int32_t this_scale, const DecimalValue& other,
                                         int32_t other_scale, int32_t result_precision,
                                         int32_t result_scale, bool round,
                                         bool* overflow) const {
    return Add<RESULT_T>(this_scale, -other, other_scale, result_precision, result_scale,
                         round, overflow);
  }

  template <typename RESULT_T>
  inline DecimalValue<RESULT_T> Multiply(int32_t this_scale, const DecimalValue& other,
                                         int32_t other_scale, int32_t result_precision,
                                         int32_t result_scale, bool round,
                                         bool* overflow) const;
  ...
  template <typename RESULT_T>
  inline DecimalValue<RESULT_T> Divide(int32_t this_scale, const DecimalValue& other,
                                       int32_t other_scale, int32_t result_precision,
                                       int32_t result_scale, bool round, bool* is_nan,
                                       bool* overflow) const;

  template <typename RESULT_T>
  inline DecimalValue<RESULT_T> Mod(int32_t this_scale, const DecimalValue& other,
                                    int32_t other_scale, int32_t result_precision,
                                    int32_t result_scale, bool round, bool* is_nan,
                                    bool* overflow) const;
  ...
  /// Compares this and other. Returns 0 if equal, < 0 if this < other and > 0 if
  /// this > other.
  inline int32_t Compare(int32_t this_scale, const DecimalValue& other,
                         int32_t other_scale) const;

  /// Comparison utilities.
  inline bool Eq(int32_t this_scale, const DecimalValue& other,
                 int32_t other_scale) const {
    return Compare(this_scale, other, other_scale) == 0;
  }
  inline bool Ne(int32_t this_scale, const DecimalValue& other,
                 int32_t other_scale) const {
    return Compare(this_scale, other, other_scale) != 0;
  }
  inline bool Ge(int32_t this_scale, const DecimalValue& other,
                 int32_t other_scale) const {
    return Compare(this_scale, other, other_scale) >= 0;
  }
  inline bool Gt(int32_t this_scale, const DecimalValue& other,
                 int32_t other_scale) const {
    return Compare(this_scale, other, other_scale) > 0;
  }
  inline bool Le(int32_t this_scale, const DecimalValue& other,
                 int32_t other_scale) const {
    return Compare(this_scale, other, other_scale) <= 0;
  }
  inline bool Lt(int32_t this_scale, const DecimalValue& other,
                 int32_t other_scale) const {
    return Compare(this_scale, other, other_scale) < 0;
  }
  ...
  inline const T whole_part(int32_t scale) const;

  /// Returns the value of the decimal after the decimal point.
  inline const T fractional_part(int32_t scale) const;
  ...
  template <typename RESULT_T>
  inline typename RESULT_T::underlying_type_t ToInt(int32_t scale, bool* overflow) const;

  /// Returns an approximate double for this decimal.
  inline double ToDouble(int32_t scale) const;

  std::string ToString(int32_t precision, int32_t scale) const;
 ...
 private:
  ...
  template <typename RESULT_T>
  static inline void AdjustToSameScale(const DecimalValue& x, int32_t x_scale,
                                       const DecimalValue& y, int32_t y_scale,
                                       int32_t result_precision, RESULT_T* x_scaled,
                                       RESULT_T* y_scaled);
};
